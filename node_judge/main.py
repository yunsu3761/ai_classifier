...
from evaluation import (
    ...
    get_node_wise_uniqueness,
    get_node_wise_segment_quality,
    get_node_wise_segment_quality_per_paper
)
...
#     parser.add_argument("--output_path", type=str)
    ...
    for dim in DIMS:
        ...
        level_wise_granularity = get_level_granularity(root, levels)
...
#             "node_wise_paper_relevance": node_wise_segment_quality
        ...
        with open(os.path.join(args.eval_path, 'eval.json'), 'w') as f:
...
#         "coverage": len(matched) / len(id2paper)
    ...
    with open(os.path.join(args.eval_path, 'eval_v1.json'), 'w') as f:
        json.dump(final_results, f, indent=4)
